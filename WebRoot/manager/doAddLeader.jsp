...
<%  
    ...
    flag=dao.save(obj);  
    if(flag){
    out.println("<script>alert('添加领导成功！');window.location.href='LeaderList.jsp';</script>"); 
    }else{
    out.println("<script>alert('添加领导失败！请检查数据重新添加');window.location.href='LeaderList.jsp';</script>"); 
    }
