...
<%  
    ...
    flag=dao.update(obj);
    if(flag){  
    out.println("<script>alert('修改信息成功！'); window.location.href='LeaderList.jsp';</script>"); 
    }else{
     out.println("<script>alert('修改信息失败！请检查数据是否正确'); window.location.href='LeaderList.jsp';</script>"); 
    }
