		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">领导列表</h4></li>
				</ul>
						...
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-btn-toolbar">
				            <div class="am-btn-group am-btn-group-xs">
				              <button type="button" class="am-btn am-btn-default" onclick = "location.href='addLeader.jsp'"><span class="am-icon-plus"></span> 新增</button>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
				  <th class="table-title">编号</th><th class="table-title">姓名</th><th class="table-title">职称</th><th class="table-title">学院</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <%for(int i=0;i<list.size();i++){  
                Leader obj=(Leader)list.get(i);
                %> 
              <tr>
                <td><%=obj.getLeaderID()%></td>
                <td><%=obj.getLeaderName()%></td>
                <td><%=obj.getJobTitle()%></td>
				<td><%=obj.getCollege()%></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick = "location.href='updateLeader.jsp?id=<%=obj.getLeaderID()%>'"><span class="am-icon-pencil-square-o"></span>修改</button>
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick = "location.href='removeLeader.jsp?id=<%=obj.getLeaderID()%>'"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
