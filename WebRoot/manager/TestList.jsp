						...
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-btn-toolbar">
				            <div class="am-btn-group am-btn-group-xs">
				              <button type="button" class="am-btn am-btn-default" onclick = "location.href='addTest.jsp?id=<%=ID%>'"><span class="am-icon-plus"></span> 新增</button>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
				  <th class="table-title">体测号</th><th class="table-title">学号</th><th class="table-title">学生姓名</th><th class="table-title">体测时间</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <%for(int i=0;i<list.size();i++){  
                TestInfo obj=(TestInfo)list.get(i);
                StudentDao studentDao = new StudentDao();
                Student student = studentDao.findById(obj.getStudentID());
                if(obj.getStudentID().equals(ID)){
                %> 
              <tr>
                <td><%=obj.getID()%></td>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick = "location.href='testInfo.jsp?id=<%=obj.getID()%>'"><span class="am-icon-pencil-square-o"></span>体测详情</button>
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick = "location.href='updateTest.jsp?id=<%=obj.getID()%>'"><span class="am-icon-pencil-square-o"></span>修改</button>
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick = "location.href='removeTest.jsp?id=<%=obj.getID()%>'"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
              </tr>
