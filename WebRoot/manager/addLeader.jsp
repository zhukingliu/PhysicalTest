		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">添加领导</h4></li>
				</ul>
					...
					<!-- Row start -->
						<div class="am-u-sm-12">
							<div class="card-box">
								...
								<form action="doAddLeader.jsp" method="post" class="am-form" data-am-validator>
									<fieldset>
										<legend>添加领导列表</legend>
										<div class="am-form-group">
											<label>教职工编号：</label>
											<input type="text" name="Id" placeholder="输入教职工编号" required/>
										</div>
										<div class="am-form-group">
											<label>姓名：</label>
										...
										<div class="am-form-group">
											<label>学院：</label>
											<input type="text" name="college" placeholder="输入学院" required/>
										</div>
