		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">添加体测信息</h4></li>
				</ul>
					...
					<!-- Row start -->
						<div class="am-u-sm-12">
							<div class="card-box">
								...
								<form action="doAddTest.jsp" method="post" class="am-form" data-am-validator>
									<fieldset>
										<legend>添加体测信息列表</legend>
										...
										<div class="am-form-group">
											<label>体测号：</label>
											<input type="text" name="testId" placeholder="输入体测号" required/>
										</div>
										<div class="am-form-group">
											<label>体测时间：</label>
										...
										<div class="am-form-group">
											<label>身高：</label>
											<input type="number" name="height" placeholder="身高（cm）" required/>
										</div>
										<div class="am-form-group">
											<label>体重：</label>
											<input type="number" name="weight" placeholder="体重（kg）" required/>
										</div>
										<div class="am-form-group">
											<label>肺活量：</label>
											<input type="number" name="vitalCapacity" placeholder="肺活量" required/>
										<div class="am-form-group">
											<label>跳远：</label>
											<input type="number" name="jump" placeholder="跳远" required/>
											<%if(flag==1){ %>
										</div>
											<div class="am-form-group">
											<label>仰卧起坐：</label>
											<input type="number" name="sitUp" placeholder="仰卧起坐" required/>
										</div>
										<div class="am-form-group">
											<label>八百米长跑：</label>
											<input type="number" name="eightHundred" placeholder="八百米长跑" required/>
										</div>
										<%}else{ %>
										<div class="am-form-group">
											<label>引体向上：</label>
											<input type="number" name="pullUp" placeholder="引体向上" required/>
										</div>
										<div class="am-form-group">
											<label>一千米长跑：</label>
											<input type="number" name="oneThousand" placeholder="一千米长跑" required/>
										</div>
										<%} %>
										<div class="am-form-group">
											<label>五十米短跑：</label>
											<input type="number" name="fifty" placeholder="五十米短跑" required/>
										</div>
										<div class="am-form-group">
											<label>体前屈：</label>
											<input type="number" name="sitAndReach" placeholder="体前屈" required/>
										</div>
