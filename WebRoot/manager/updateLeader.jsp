...
<html>
   ...
   // 获取cookies的数据,是一个数组
         ...
         Leader leader= leaderDao.findById(ID);
         %> 
		<meta charset="utf-8" />
					...
					<!-- Row start -->
						<div class="am-u-sm-12">
							<div class="card-box">
								...
								<form action="doUpdateLeader.jsp" method="post" class="am-form" data-am-validator>
									<fieldset>
										<legend>修改领导信息</legend>
										<div class="am-form-group">
											<label>教职工编号：</label>
											<input type="text" name="Id" value="<%=leader.getLeaderID()%>" required/>
										</div>
										<div class="am-form-group">
											<label>姓名：</label>
											<input type="text" name="Name" value="<%=leader.getLeaderName()%>" placeholder="输入姓名" required/>
										</div>
										<div class="am-form-group">
											<label>学院：</label>
											<input type="text" name="college" value="<%=leader.getCollege()%>" placeholder="输入学院" required/>
										</div>

                                       <div class="am-form-group">
										    <label>职称：</label>
											<select name="jobTitle" required>
											<%if(leader.getJobTitle().equals("教授")){ %>
												<option selected = "true">教授</option>
												<option>副教授</option>
												<option>讲师</option>
												<option>助教</option>
												<%}else if(leader.getJobTitle().equals("副教授")){ %>
												<option>教授</option>
												<option selected = "true">副教授</option>
												<option>讲师</option>
												<option>助教</option>
												<%}else if(leader.getJobTitle().equals("讲师")){ %>
												<option>教授</option>
												<option>副教授</option>
