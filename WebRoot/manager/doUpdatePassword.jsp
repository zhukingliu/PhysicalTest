   ...
   // 获取cookies的数据,是一个数组
    ...
    String reNewPassword=request.getParameter("reNewPassword");
     ...
     Manager obj=new Manager();
      if(newPassword.equals(reNewPassword) && obj.getPassword().equals(oldPassword)){  
       obj.setId(ID);
    ...
    flag=dao.update(obj);
    if(flag){  
    out.println("<script>alert('修改密码成功！'); window.location.href='LeaderList.jsp';</script>"); 
    }else{
     out.println("<script>alert('修改密码失败！请检查数据是否正确'); window.location.href='LeaderList.jsp';</script>"); 
    }
